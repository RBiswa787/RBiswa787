...
function populateCartitems() {
    ...
    CART_ITEMS === null || CART_ITEMS === void 0 ? void 0 : CART_ITEMS.appendChild(ORDER_HEADER);
    ...
    Object.keys(cart).forEach(key => {
        ...
        CART_ITEMS === null || CART_ITEMS === void 0 ? void 0 : CART_ITEMS.appendChild(CARD);
        CART_ITEMS === null || CART_ITEMS === void 0 ? void 0 : CART_ITEMS.appendChild(CONTROL);
    ...
    STANDARD === null || STANDARD === void 0 ? void 0 : STANDARD.addEventListener("click", () => {
    ...
    EXPRESS === null || EXPRESS === void 0 ? void 0 : EXPRESS.addEventListener("click", () => {
        delivery_charges = 50;
        const SPAN_DELIVERY = document.getElementById("span-delivery");
        SPAN_DELIVERY.innerText = "Rs. 50";
        const SPAN_TOTAL = document.getElementById("span-total");
...
function populateWishlist() {
    ...
    products.forEach(product => {
        ...
        WISHLIST_CONTENT === null || WISHLIST_CONTENT === void 0 ? void 0 : WISHLIST_CONTENT.appendChild(CARD);
    });
}
